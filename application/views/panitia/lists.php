                                                ...
                                                <div class="margin">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <a class="dropdown-item" href="<?php echo base_url() ?>panitia/edit/<?php echo $item->id ?>">Ubah</a>
                                                            <a class="dropdown-item" href="<?php echo base_url() ?>panitia/delete/<?php echo $item->id.'/'.$item->divisi ?>">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                            </div>
