                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="float-sm-right col-md-2">
                                    <a href="<?php echo base_url() ?>rapat" class="btn btn-block btn-success btn-flat"><i class="fa fa-plus"></i> Tambah Rapat</a>
                                </div>
                                                ...
                                                <div class="margin">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <a class="dropdown-item" href="<?php echo base_url() ?>rapat/edit/<?php echo $item->id ?>">Ubah</a>
                                                            <a class="dropdown-item" href="<?php echo base_url() ?>rapat/delete/<?php echo $item->id ?>">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                            </div>
